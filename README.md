...
|-|-|-|-|-|
| AB | Bemaniso | ? | PU+, no paranoia, tell recruiter which rhythm games you play | 0 |
| AB | BrokenStones | ? | PU+, 6 months | 0 |
| AB | Concertos | ? | PU+ | 0 |
...
| AB | SocietyGlitch | ? | PU+, account in good standing, explain why you want in | 0 |
| AB | TeamHD | ? | PU+ | 0 |
| AB | TheGeeks | ? | PU+ | 0 |
| AB | Awesome-HD | ? | PU+, 3 months | 0 |
| AB | BaconBits | ? | EU+, 6 months | 0 |
| AB | FunFile | ? | PU+ | 0 |
| AB | GazelleGames | ? | PU+, 3 months | 0 |
| AB | In The Shadow | ? |  | 0 |
| AB | LzTr | ? | PU+, 3 months | 0 |
| AB | MoreThanTV | ? | PU+, 6 months, 1.5+ ratio, no warnings, favourite TV show | 0 |
| AB | PixelHD | ? | EU+ | 0 |
| AB | TeamHD | ? | PU+ | 0 |
| AB | TheGeeks | ? | PU+ | 0 |
| AB | ThePlace | ? | PU+ | 0 |
...
| BTN | PixelCove | ? | PU+, no warnings | 0 |
| BTN | PixelHD | ? | PU+ | 0 |
| BTN | PreToMe | ? | PU+ | 0 |
| BTN | SDBits | ? | PU+ | 0 |
| BTN | STL Land | ? | PU+ | 0 |
...
| HDS | KeepFRDS | ? | IU+, 2000 days seed time | 0 |
| HDS | LeagueHD | ? | PU+ | 0 |
...
| M-Team | Tjupt | ? | CU+ | 0 |
| M-Team | ToTheGlory | ? | EU+, 2.3TB+ download, seedtime 10000 days, 700k+ BP<br>alternatively CU+ with no requirements | 0 |
...
| MTV | Orpheus | ? |  | 0 |
| MTV | PirateTheNet | ? | Camera Operator+ | 0 |
...
| SpringSunday | HDChina | ? | CU+, 400k+ bonus, same username/email | 0 |
...
| TPS | TheOccult | ? | PU+, 1 year, 20 forum posts | 0 |
